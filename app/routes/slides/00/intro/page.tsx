...
const IntroSlides = () => {
  return (
    ...
    <img width={500} src={nightskyline} alt="Hong kong skyline" className="fragment"/>
    <img width={500} src={usfca} alt="campus" className="fragment"/>
    </div>
    </section>
    </section>
    <section>
    ...
    <section>
    <div className="fragment r-hstack">
    Sailing
    Programming
    Teaching
    </div>
    ...
    <section>
    <div className="flex flex-row fragment">
    <ul>
    ...
    <img src={nightskyline} alt="Skyline" />
    </div>
    </section>
    </section>
    <section>
    ...
    <section>
    <ul>
    <li className="fragment">I will post the slides online after class.</li>
    <li className="fragment">I may post the code written in class on Canvas, on CampusWire, or on GitHub (more on this later) depending on the context.</li>
    <li className="fragment">I’m okay with you all using your computers and tablets, but please be productive in class and pay attention. I don’t want to end up repeating myself every time in Office Hours because you were doing something else in class.</li>
      </ul>
    </section>
    </section>
    <section>
    ...
    <img height={500} src={gradingTable} alt="Grading Table" className="fragment"/>
    </section>
    <section>
